...
(function (global) {
    ...
    function createMonthTable(data, option) {
        ...
        for (c = 0; c <= 6; c = c + 1) {
            ...
            tr.appendChild(td);
			td.setAttribute("onClick", "tdClick("+c+")");
			td.setAttribute("style", "color:blue;font-weight:bold;");
        }
...
{
	var news = val-1;
	var chekcDate = news+"-"+chk_mnth+"-"+chk2;
	...
	document.getElementById(val).classList.add("dycalendar-target-date");
	 ...
	 document.getElementById("js-todo-input2").value = chekcDate;
